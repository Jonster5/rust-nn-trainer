...
impl Matrix {
    ...
    pub fn map_matrices(m: &Self, func: fn(x: f64, r: usize, c: usize) -> f64) -> Self {
    ...
    pub fn addition(a: &Self, b: &Self) -> Self {
    ...
    pub fn subtract_value(mut self, value: f64) -> Self {
        for i in 0..self.rows {
            for j in 0..self.cols {
                self.data[i][j] -= value;
            }
    ...
    pub fn subtraction(a: &Self, b: &Self) -> Self {
        // panic if rows and colums don't match
        assert_eq!(a.rows, b.rows);
    ...
    pub fn multiplication(a: &Self, b: &Self) -> Self {
        // panic if rows and colums don't match
